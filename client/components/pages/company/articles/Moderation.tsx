                ...
                <div className="article_content">
                    <div className="article_main">
                        ...
                        <section className="article_section">
                            ...
                            <h2>Banning a user from a room</h2>
                        ...
                        <section className="article_section">
                            ...
                            <ul>
                                <li>Sexual harassment is <strong>never</strong> okay on Nextbeat. Offenders who make sexually inappropriate or hostile remarks should be permanently removed from the chat.</li>
