...
export enum ActionType {
    ...
    REVOKE_SOCIAL_ACCOUNT = 'REVOKE_SOCIAL_ACCOUNT',
    ...
    EMOJIS = 'EMOJIS',
    SELECT_EMOJI_FILE = 'SELECT_EMOJI_FILE',
    SET_EMOJI_FILE_ERROR = 'SET_EMOJI_FILE_ERROR',
    ADD_EMOJI = 'ADD_EMOJI',
    REMOVE_EMOJI = 'REMOVE_EMOJI',
    SHOP_PRODUCTS = 'SHOP_PRODUCTS',
    ADD_SHOP_PRODUCT = 'ADD_SHOP_PRODUCT',
    REMOVE_SHOP_PRODUCT = 'REMOVE_SHOP_PRODUCT',
